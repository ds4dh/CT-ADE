class Config:
    ...
    # Training
    output_dir = "./meditron-70b-SOC"
    num_train_epochs = 5
    per_device_train_batch_size = 1 # 2 for 7/8B, 1 for 70B
    per_device_eval_batch_size = 1 # 2 for 7/8B, 1 for 70B
    gradient_accumulation_steps = 4 # 2 for 7/8B, 4 for 70B
